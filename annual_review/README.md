...
1. Before the review meeting, the student submits:
   - an updated CV; and
   - Part 1, Student Self-Review.
2. Before the review meeting, Nobu completes Part 2, PI Assessment.
3. During the review meeting, the student and Nobu:
   - discuss the student self-review and PI assessment; and
   - jointly complete Part 3, Joint Plan.
4. After the discussion, Nobu completes Part 4, Annual Review Outcome, and shares the completed review with the student.
5. The student and Nobu sign the acknowledgment confirming that the review was discussed and received. A signature does not necessarily indicate agreement with every part of the evaluation.
6. The student completes the Student Feedback on PI and Mentoring section. Nobu reviews this feedback only after the annual review outcome has been documented.

Nobu's CV is available [here](https://mizumoto-lab.com/files/CV_NobuakiMizumoto.pdf) as a general formatting reference. Graduate student CVs will normally be shorter and may be organized differently.

Completed annual reviews, stipend decisions, and student feedback are confidential and must not be stored in the public lab-handbook repository. Final records should be stored in a private, university-approved location.
